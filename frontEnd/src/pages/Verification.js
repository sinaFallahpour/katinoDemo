          ...
          <aside className="col-12 col-lg-5 mx-auto">
            <form className="w-100" onSubmit={this.submitHandler.bind(this)}>
              <div className="bg-white srounded-md sp-2 smb-2">
                ...
                <input placeholder="کد تایید" type="text" className="w-100 m-0 my-2 py-2 px-3 text-right" value={this.state.verification.verifyCode} onChange={this.isInputValid.bind(this)}
