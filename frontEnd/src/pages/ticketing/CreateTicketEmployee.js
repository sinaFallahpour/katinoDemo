          ...
          <aside className="col-12 col-lg-6 mx-auto">
            <div className="sbs-shadow srounded-md bg-white sp-2">
              ...
              <form onSubmit={this.submitTicketAnswer}>
                ...
                />
                <div className="choose-support m-0 my-2 ir-b p-0 d-flex flex-column justify-content-start align-items-start">
                  ...
                  <div className="w-100 ir-r m-0 p-0 d-flex flex-row flex-wrap justify-content-start align-items-baseline">
                    ...
                    <div className="m-0 p-0 pl-md-1 pl-0 col-md-5 col-12">
                      <input onChange={(e) => {
                        if (e.target.checked) {
                          this.setState({ City: "" });
                        }
                      }} name="job_support" id="katino_job" type="radio" className="" defaultChecked />
                      <label htmlFor="katino_job" className="m-0 mr-1 p-0">کاتینو جاب</label>
                    </div>
                    <label htmlFor="city_agent" className="m-0 p-0 pr-md-1 pr-0 col-md-7 col-12 d-flex flex-row justify-content-start align-items-baseline">
                      <input name="job_support" id="city_agent" type="radio" className="mr-l" />

                      <select
                        onClick={() => { document.getElementById("city_agent").checked = true; }}
                        className="form-control ir-r fs-s mt-0 mr-1 smb-2 srounded-sm shadow-none"
                        style={{ resize: "none" }}
                        id="subject"
                        placeholder="شهر"
                        rows="4"
                  ...
                  {this.state.cities && (
                      <Select
                        ...
                        style={{ color: "#555" }}
                        className="w-100  ir-r fs-s mt-2 smb-2 srounded-sm shadow-none"
                      />)
                    }
                </div>
                <select
