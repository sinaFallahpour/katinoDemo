...
const UploadPdf = () => {
  ...
  const [loadedResume, setLoadedResume] = useState();
  ...
  const onDrop = useCallback((acceptedFiles) => {
    acceptedFiles.forEach(file => {
      ...
      if (5243000 > file.size && (file.type === "application/pdf" || file.type === "image/jpeg" || file.type === "image/png")) {
  ...
  return (
    <div>
      <h3 className="d-block text-right ir-b smb-3 c-dark">
        بارگذاری رزومه
        <span className="m-0 mr-1 p-0" style={{ fontSize: ".90rem" }}>(pdf, jpg, png)</span>
      </h3>
