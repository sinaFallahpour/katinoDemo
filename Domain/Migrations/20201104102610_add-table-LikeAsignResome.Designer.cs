...
namespace Domain.Migrations
{
    ...
    [Migration("20201104102610_add-table-LikeAsignResome")]
    partial class addtableLikeAsignResome
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.LikeAsignResome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Resome", b =>
                {
                    ...
                    b.HasIndex("EducationalBackgroundId")
                        .IsUnique()
                        .HasFilter("[EducationalBackgroundId] IS NOT NULL");

                    b.HasIndex("UserJobPreferencesId")
                        .IsUnique()
                        .HasFilter("[UserJobPreferencesId] IS NOT NULL");

                    b.HasIndex("UserJobSkillId")
                        .IsUnique()
                        .HasFilter("[UserJobSkillId] IS NOT NULL");

                    b.HasIndex("UserLanguageId")
                        .IsUnique()
                        .HasFilter("[UserLanguageId] IS NOT NULL");

                    b.HasIndex("UserWorkExperienceId")
                        .IsUnique()
                        .HasFilter("[UserWorkExperienceId] IS NOT NULL");
            ...
            modelBuilder.Entity("Domain.Resome", b =>
                {
                    b.HasOne("Domain.EducationalBackground", "EducationalBackground")
                        .WithOne("Resome")
                        .HasForeignKey("Domain.Resome", "EducationalBackgroundId");

                    b.HasOne("Domain.UserJobPreferences", "UserJobPreferences")
                        .WithOne("Resome")
                        .HasForeignKey("Domain.Resome", "UserJobPreferencesId");

                    b.HasOne("Domain.UserJobSkill", "UserJobSkill")
                        .WithOne("Resome")
                        .HasForeignKey("Domain.Resome", "UserJobSkillId");

                    b.HasOne("Domain.UserLanguage", "UserLanguage")
                        .WithOne("Resome")
                        .HasForeignKey("Domain.Resome", "UserLanguageId");

                    b.HasOne("Domain.UserWorkExperience", "UserWorkExperience")
                        .WithOne("Resome")
                        .HasForeignKey("Domain.Resome", "UserWorkExperienceId");
                });
