...
namespace Domain.Migrations
{
    ...
    [Migration("20201006104911_add-resome-in-db")]
    partial class addresomeindb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.EducationalBackground", b =>
                {
                    b.HasOne("Domain.Resome", "Resome")
                        ...
                        .HasForeignKey("Domain.EducationalBackground", "ResomeId")
            ...
            modelBuilder.Entity("Domain.UserJobPreferences", b =>
                {
                    b.HasOne("Domain.Resome", "Resome")
                        .WithOne("UserJobPreferences")
                        .HasForeignKey("Domain.UserJobPreferences", "ResomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.UserJobSkill", b =>
                {
                    ...
                    b.HasOne("Domain.Resome", "Resome")
                        .WithOne("UserJobSkill")
                        .HasForeignKey("Domain.UserJobSkill", "ResomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.UserLanguage", b =>
                {
                    ...
                    b.HasOne("Domain.Resome", "Resome")
                        ...
                        .HasForeignKey("Domain.UserLanguage", "ResomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Domain.UserWorkExperience", b =>
                {
                    b.HasOne("Domain.Resome", "Resome")
                        .WithOne("UserWorkExperience")
                        .HasForeignKey("Domain.UserWorkExperience", "ResomeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
