...
namespace Domain.Migrations
{
    ...
    [Migration("20210704055736_AddResomeColorsToAdver")]
    partial class AddResomeColorsToAdver
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.ContactUsMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.EmployeeFactor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("EmployeePlanId");

                    b.ToTable("EmployeeFactors");
                });

            modelBuilder.Entity("Domain.EmployeePayment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.EmployeePlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.EmployeeTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Entities.EmailNotification", b =>
                {
                    ...
                    b.Property<int>("EmailNotificationSendTime")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Entities.RefrenceDepositRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AdminDescriptions")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RefrenceDescription")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RefrenceId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("RefrenceTransationStatus")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RefrenceId");

                    b.HasIndex("UserId");

                    b.ToTable("RefrenceDepositRequest");
                });

            modelBuilder.Entity("Domain.Entities.RefrenceTransation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("RefrenceTransations");
                });

            modelBuilder.Entity("Domain.Entities.ReportAdvert", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ReportAdverts");
                });

            modelBuilder.Entity("Domain.Entities.ResomeColors", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Entities.StorySizeNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("StorySizeNotifications");
                });
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.Property<double>("RefrencePercent")
                        .HasColumnType("float");

                    b.Property<decimal>("RefrenceTotalPrice")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("SpecialEmpolyee")
                        .HasColumnType("int");

                    b.Property<string>("StaticPhoneNumber")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("StorySazCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.JobAdvertisement", b =>
                {
                    ...
                    b.Property<string>("StaticNumber")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Domain.Payment", b =>
                {
                    ...
                    b.Property<int?>("RefrenceTransationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RefrenceTransationId");
            ...
            modelBuilder.Entity("Domain.EmployeeFactor", b =>
                {
                    b.HasOne("Domain.Entities.User", "Employee")
                        .WithMany("EmployeeFactors")
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Domain.EmployeePlan", "EmployeePlan")
                        .WithMany("EmployeeFactors")
                        .HasForeignKey("EmployeePlanId");
                });
            ...
            modelBuilder.Entity("Domain.EmployeeTransaction", b =>
                {
                    b.HasOne("Domain.EmployeePayment", "EmployeePayment")
            ...
            modelBuilder.Entity("Domain.Entities.RefrenceDepositRequest", b =>
                {
                    b.HasOne("Domain.Entities.User", "Refrence")
                        .WithMany("RefrenceDepositRequest2")
                        .HasForeignKey("RefrenceId");

                    b.HasOne("Domain.Entities.User", null)
                        .WithMany("RefrenceDepositRequest")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("Domain.Entities.RefrenceTransation", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.User", "Refrence")
                        .WithMany("RefrenceTransations2")
                        .HasForeignKey("RefrenceId");

                    b.HasOne("Domain.Entities.User", "User")
                        .WithMany("RefrenceTransations")
                        .HasForeignKey("UserId");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Services", b =>
                {
                    b.HasOne("Domain.Entities.Services", null)
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Domain.JobAdvertisement", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ResomeColors", "ResomeColor")
                        .WithMany()
                        .HasForeignKey("ResomeColorId");
                });
            ...
            modelBuilder.Entity("Domain.Payment", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.RefrenceTransation", "RefrenceTransations")
                        .WithMany()
                        .HasForeignKey("RefrenceTransationId");
